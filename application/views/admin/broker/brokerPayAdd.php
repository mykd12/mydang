<div class="col g-ml-45 g-ml-0--lg g-pb-65--md">
  ...
  <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
    <ul class="u-list-inline g-color-gray-dark-v6 add-location">
      ...
      <li class="list-inline-item g-mr-10">
        <a class="u-link-v5 g-color-gray-dark-v6 g-color-lightblue-v3--hover g-valign-middle" href="#!">중개사</a>
        <i class="hs-admin-angle-right g-font-size-12 g-color-gray-light-v6 g-valign-middle g-ml-10"></i>
      </li>
  ...
  <div class="g-pa-20" id="CTs-write">
    ...
    <form id='frm' name='frm' action="/adminDAO/brokerPayAdd" method="post" onsubmit="return submit_ck();">
      ...
      <div class="row">
        ...
        <div class='col-md-12 text-center'>
          ...
          <a href="/admin/brokerPaym?key=<?php echo $key;?>" class="btn btn-md u-btn-outline-bluegray g-mb-15">LIST</a>
        </div>
      </div>
    </form>
  </div>
