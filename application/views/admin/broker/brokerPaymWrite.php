<div class="col g-ml-45 g-ml-0--lg g-pb-65--md">
  ...
  <div class="g-pa-20" id="CTs-write">
    ...
    <form id='frm' name='frm' action="/adminDAO/brokerPaymWirte" method="post" onsubmit="return submit_ck();">
      ...
      <div class="row">
            ...
            <div class="row">
              <div class="form-group g-mb-20 col-md-4">
                ...
                <input
                  ...
                  type="text" value="<?php echo $user->BKT_COMPANY;?>" readonly>
              </div>
              <div class="form-group g-mb-20 col-md-4">
        ...
        <div class='col-md-12 text-center'>
          <a href="/admin/brokerPaym?key=<?php echo $key;?>&pageNo=<?php echo $pageNo;?>&search=<?php echo $search;?>"
