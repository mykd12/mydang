  ...
  <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
    <ul class="u-list-inline g-color-gray-dark-v6 add-location">
      ...
      <li class="list-inline-item">
        <span class="g-valign-middle">분류(대) 코드 MODIFY</span>
      </li>
    </ul>
  </div>
  <!-- End Breadcrumb-v1 -->
  ...
  <div class="g-pa-20" id="CTs-write">
    <div class="media">
      <div class="d-flex align-self-center">
        <h1 class="g-font-weight-300 g-font-size-25 g-color-black mb-0 page-big-title">분류(대) 코드 MODIFY</h1>
      </div>
    </div>
    <hr class="d-flex g-brd-gray-light-v7 g-my-30">
    <form id='frm' name='frm' action="/adminDAO/codeAwrite" method="post">
      <input type='hidden' id='CAT_IDX' name='CAT_IDX' value='<?php echo $CAT_IDX;?>' />
      ...
      <div class="row">
        ...
        <div class="col-md-12 ">
            ...
            <div class="row">
              <div class="form-group g-mb-20 col-md-6">
                ...
                <input
                  ...
                  value="<?php if($CAT_IDX && $results->CAT_CODE) echo $results->CAT_CODE;?>">
              </div>
              <div class="form-group g-mb-20 col-md-6">
                ...
                <input
                  ...
                  value="<?php if($CAT_IDX && $results->CAT_NAME) echo $results->CAT_NAME;?>"
          ...
          <div class='col-md-12 text-center'>
            ...
            <a href="codeA?pageNo=<?=$pageNo?>&search=<?=$search?>"
