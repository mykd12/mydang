  ...
  <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
    <ul class="u-list-inline g-color-gray-dark-v6 add-location">
      ...
      <li class="list-inline-item">
        <span class="g-valign-middle">지역 코드(구/군) MODIFY</span>
      </li>
    </ul>
  </div>
  <!-- End Breadcrumb-v1 -->
  ...
  <div class="g-pa-20" id="CTs-write">
    <div class="media">
      <div class="d-flex align-self-center">
        <h1 class="g-font-weight-300 g-font-size-25 g-color-black mb-0 page-big-title">지역 코드(구/군) MODIFY</h1>
      </div>
    </div>
    <hr class="d-flex g-brd-gray-light-v7 g-my-30">
    <form id='frm' name='frm' action="/adminDAO/codeEwrite" method="post">
      <input type='hidden' id='CET_IDX' name='CET_IDX' value='<?php echo $CET_IDX;?>' />
      ...
      <div class="row">
        ...
        <div class="col-md-12 ">
            ...
            <div class="row">
              <div class="form-group g-mb-20 col-md-4">
                ...
                <input
                  ...
                  name='CET_AREA_A' id='CET_AREA_A' type="text"
                  value="<?php if($CET_IDX && $results->CET_AREA_A) echo $results->CET_AREA_A;?>" readonly>
              </div>
              <div class="form-group g-mb-20 col-md-4">
                <h4 class="h6 g-font-weight-600 g-color-black g-mb-10">CODE</h4>
                <input
                  class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus rounded-0 g-px-14"
                  name='CET_CODE' id='CET_CODE' type="text"
                  value="<?php if($CET_IDX && $results->CET_CODE) echo $results->CET_CODE;?>">
              </div>
              <div class="form-group g-mb-20 col-md-4">
                <h4 class="h6 g-font-weight-600 g-color-black g-mb-10">명칭</h4>
                <input
                  class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus rounded-0 g-px-14"
                  name='CET_AREA' id='CET_AREA' type="text"
                  value="<?php if($CET_IDX && $results->CET_AREA) echo $results->CET_AREA;?>"
          ...
          <div class='col-md-12 text-center'>
            ...
            <a href="codeE?pageNo=<?=$pageNo?>&search=<?=$search?>"
