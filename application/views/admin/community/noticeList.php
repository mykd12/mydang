        <div class="col g-ml-50 g-ml-0--lg g-overflow-hidden">
          ...
          <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
            <ul class="u-list-inline g-color-gray-dark-v6 add-location">
              ...
              <li class="list-inline-item g-mr-10">
                <a class="u-link-v5 g-color-gray-dark-v6 g-color-lightblue-v3--hover g-valign-middle" href="#!">NOTICE
                  LIST</a>
              </li>
          ...
          <div class="g-pa-20 CTs-list-notice m---style01" id="CTs-list">
            ...
            <div class="media">
              <div class="d-flex align-self-center">
                <h1 class="g-font-weight-300 g-font-size-25 g-color-black mb-0 page-big-title">NOTICE LIST</h1>
              </div>
              <div class="media-body align-self-center text-right">
                <a class=" btn btn u-btn-primary g-width-100--md g-font-size-default g-ml-10" href="noticeWrite">+ ADD
                </a>
              </div>
            </div>
            ...
            <div class="media-md align-items-center g-mb-30">
              <div class="media d-md-flex align-items-center ml-auto">
                <div class="d-flex g-ml-15 g-ml-55--md">
                  <form action='notice' method='get' id='frm' name='frm'>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class='table_title'>
                        <a href='noticeView?NOT_IDX=<?php echo $data->NOT_IDX;?>&pageNo=<?php echo $pageNo;?>&search=<?php echo $search;?>'
                          class="g-color-black"><?php echo $data->NOT_TITLE;?></a>
                      </td>
                      <td><?php echo $data->NOT_REG_DATE;?></td>
                      <td class="text-right">
                        <a href="noticeWrite?NOT_IDX=<?php echo $data->NOT_IDX;?>&pageNo=<?php echo $pageNo;?>&search=<?php echo $search;?>"
                          class="btn btn-xs u-btn-indigo g-mr-10 ">
                          <i class="hs-admin-pencil g-mr-3"></i>
                          MODIFY
                        </a>
                        <a href="/adminDAO/noticeDelete?NOT_IDX=<?php echo $data->NOT_IDX?>&search=<?php echo $search;?>&pageNo=<?php echo $pageNo;?>"
