        <div class="col g-ml-50 g-ml-0--lg ">
          ...
          <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
            <ul class="u-list-inline g-color-gray-dark-v6 add-location">
              ...
              <li class="list-inline-item">
                <span class="g-valign-middle">NOTICE DETAIL</span>
              </li>
            </ul>
          </div>
          <!-- End Breadcrumb-v1 -->
          ...
          <div class="g-pa-20" id="CTs-view">
              ...
              <div class="d-flex align-self-center">
                <h1 class="g-font-weight-300 g-font-size-25 g-color-black mb-0 page-big-title">NOTICE DETAIL</h1>
              </div>
            </div>
              ...
              <div class="col-md-12">
                ...
                <div class="card g-brd-gray-light-v7 g-rounded-3 g-mb-30 add-view-page">
                  <header class="card-header g-bg-transparent g-brd-bottom-none g-px-15 g-px-30--sm g-pt-15 g-pt-20--sm pb-0">
                    <div class="media">
                      <h3 class="media-body d-flex align-self-center text-uppercase g-font-size-28 g-font-size-25--md g-color-black mb-0 view_title" ><?php echo $results->NOT_TITLE?></h3>
                        ...
                        <div class="align-self-center g-pos-rel g-z-index-2">
                          ...
                          <div id="dropDown4" class="u-shadow-v31 g-pos-abs g-right-0 g-bg-white" aria-labelledby="dropDown4Invoker">
                            <ul class="list-unstyled g-nowrap mb-0">
                              <li>
                                <a class="d-flex align-items-center u-link-v5 g-bg-gray-light-v8--hover g-font-size-12 g-font-size-default--md g-color-gray-dark-v6 g-px-25 g-py-14" href="noticeWrite?NOT_IDX=<?php echo $results->NOT_IDX?>&pageNo=<?php echo $pageNo;?>&search=<?php echo $search;?>">
                                  <i class="hs-admin-pencil g-font-size-18 g-color-gray-light-v6 g-mr-10 g-mr-15--md"></i>
                                  MODIFY
                                </a>
                              </li>
                              <li>
                                <a class="d-flex align-items-center u-link-v5 g-bg-gray-light-v8--hover g-font-size-12 g-font-size-default--md g-color-gray-dark-v6 g-px-25 g-py-14" href="/adminDAO/noticeDelete?NOT_IDX=<?php echo $NOT_IDX?>&search=<?php echo $search;?>&pageNo=<?php echo $pageNo;?>"  onclick="return confirm('삭제하시겠습니까?');">
