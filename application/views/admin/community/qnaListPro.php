<div class="col g-ml-50 g-ml-0--lg g-overflow-hidden">
  ...
  <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
    <ul class="u-list-inline g-color-gray-dark-v6 add-location">
      ...
      <li class="list-inline-item g-mr-10">
        <a class="u-link-v5 g-color-gray-dark-v6 g-color-lightblue-v3--hover g-valign-middle" href="#!">PRO QNA
          리스트</a>
      </li>
  ...
  <div class="g-pa-20 CTs-list-notice m---style01" id="CTs-list">
    ...
    <div class="media">
      <div class="d-flex align-self-center">
        <h1 class="g-font-weight-300 g-font-size-25 g-color-black mb-0 page-big-title">PRO QNA 리스트</h1>
      </div>
    </div>
    ...
    <div class="media-md align-items-center g-mb-30">
      <div class="media d-md-flex align-items-center ml-auto">
        <div class="d-flex g-ml-15 g-ml-55--md">
          <form action='qnaPro' method='get' id='frm' name='frm'>
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo $data->PQT_TYPE;?>
              </td>
              <td class='table_title'><a
                  href='qnaViewP?PQT_IDX=<?php echo $data->PQT_IDX;?>&pageNo=<?php echo $pageNo;?>&search=<?php echo $search;?>'
                  class="g-color-black"><?php echo decrypt($data->PQT_NAME);?></a></td>
              <td>
                <?php echo decrypt($data->PQT_TEL);?>
              </td>
              <td><?php echo $data->PQT_REG_DATE;?></td>
              <td class="text-right">
                <a href="/adminDAO/qnaPDelete?PQT_IDX=<?php echo $data->PQT_IDX?>&search=<?php echo $search;?>&pageNo=<?php echo $pageNo;?>"
