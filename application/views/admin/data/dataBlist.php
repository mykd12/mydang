<div class="col g-ml-50 g-ml-0--lg g-overflow-hidden">
  ...
  <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
    <ul class="u-list-inline g-color-gray-dark-v6 add-location">
      ...
      <li class="list-inline-item g-mr-10">
        <a class="u-link-v5 g-color-gray-dark-v6 g-color-lightblue-v3--hover g-valign-middle" href="#!">지역별 유동 인구수
          리스트</a>
      </li>
  ...
  <div class="g-pa-20 CTs-list-notice m---style01" id="CTs-list">
    ...
    <div class="media">
      <div class="d-flex align-self-center">
        <h1 class="g-font-weight-300 g-font-size-25 g-color-black mb-0 page-big-title">지역별 유동 인구수 리스트</h1>
      </div>
    </div>
      ...
      <div class="media d-md-flex align-items-center mr-auto ">
        <div class="d-flex align-items-center">
          <a class=" btn btn u-btn-indigo g-width-130--md g-font-size-default g-ml-10"
            href="dataBexcel?search=<?php echo $search;?>" target='_blank'>엑셀 출력</a>
        </div>
      </div>
      <div class="media d-md-flex align-items-center ml-auto">
        <div class="d-flex g-ml-15 g-ml-55--md">
          <form action='dataB' method='get' id='frm' name='frm'>
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href='dataBwrite?DBT_IDX=<?php echo $data->DBT_IDX; ?>&pageNo=<?php echo $pageNo;?>&search=<?php echo $search;?>'
                  class="g-color-black"><?php echo $data->DBT_AREA_A;?></a>
              </td>
              <td>
                <a href='dataBwrite?DBT_IDX=<?php echo $data->DBT_IDX; ?>&pageNo=<?php echo $pageNo;?>&search=<?php echo $search;?>'
                  class="g-color-black"><?php echo $data->DBT_AREA_B;?></a>
              </td>
              <td>
                <a href='dataBwrite?DBT_IDX=<?php echo $data->DBT_IDX; ?>&pageNo=<?php echo $pageNo;?>&search=<?php echo $search;?>'
                  class="g-color-black"><?php echo $data->DBT_AREA_C;?></a>
              </td>
              <td>
                <a href='dataBwrite?DBT_IDX=<?php echo $data->DBT_IDX; ?>&pageNo=<?php echo $pageNo;?>&search=<?php echo $search;?>'
                  class="g-color-black"><?php echo number_format($data->DBT_CNT_A);?></a>
              </td>
              <td>
                <a href='dataBwrite?DBT_IDX=<?php echo $data->DBT_IDX; ?>&pageNo=<?php echo $pageNo;?>&search=<?php echo $search;?>'
                  class="g-color-black"><?php echo number_format($data->DBT_CNT_B);?></a>
              </td>
              <td><?php echo $data->DBT_REG_DATE;?></td>
              <td class="text-right">
                <a href="dataBwrite?DBT_IDX=<?php echo number_format($data->DBT_IDX); ?>&pageNo=<?php echo $pageNo;?>&search=<?php echo $search;?>"
                  class="btn btn-xs u-btn-indigo g-mr-10 ">
                  <i class="hs-admin-pencil g-mr-3"></i>
                  MODIFY
                </a>
                <a href="/adminDAO/dataBdelete?DBT_IDX=<?php echo $data->DBT_IDX; ?>&pageNo=<?php echo $pageNo;?>&search=<?php echo $search;?>"
