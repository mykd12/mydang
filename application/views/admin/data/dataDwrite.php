          ...
          <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
            <ul class="u-list-inline g-color-gray-dark-v6 add-location">
              ...
              <li class="list-inline-item">
                <span class="g-valign-middle">지역별 직장인 소득액 MODIFY</span>
              </li>
            </ul>
          </div>
          <!-- End Breadcrumb-v1 -->
          ...
          <div class="g-pa-20" id="CTs-write">
            <div class="media">
              <div class="d-flex align-self-center">
                <h1 class="g-font-weight-300 g-font-size-25 g-color-black mb-0 page-big-title">지역별 직장인 소득액 MODIFY</h1>
              </div>
            </div>
            <hr class="d-flex g-brd-gray-light-v7 g-my-30">
            <form id='frm' name='frm' action="/adminDAO/dataDwrite" method="post" onsubmit="return submit_ck();">
              <input type='hidden' id='DDT_IDX' name='DDT_IDX' value='<?php echo $DDT_IDX;?>' />
              ...
              <div class="row">
                ...
                <div class="col-md-12 ">
                    ...
                    <div class="row">
                      <div class="form-group g-mb-20 col-md-4">
                        ...
                        <input
                          ...
                          name='DDT_AREA_A' id='DDT_AREA_A' type="text"
                          value="<?php if($DDT_IDX && $results->DDT_AREA_A) echo $results->DDT_AREA_A;?>" readonly>
                      </div>
                      <div class="form-group g-mb-20 col-md-4">
                        <h4 class="h6 g-font-weight-600 g-color-black g-mb-10">구/군</h4>
                        <input
                          class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus rounded-0 g-px-14"
                          name='DDT_AREA_B' id='DDT_AREA_B' type="text"
                          value="<?php if($DDT_IDX && $results->DDT_AREA_B) echo $results->DDT_AREA_B;?>" readonly
                          placeholder='구/군을 입력 해주세요.'>
                      </div>
                      <div class="form-group g-mb-20 col-md-4">
                        <h4 class="h6 g-font-weight-600 g-color-black g-mb-10">소득액</h4>
                        <input
                          class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus rounded-0 g-px-14"
                          name='DDT_CNT' id='DDT_CNT' type="text"
                          value="<?php if($DDT_IDX && $results->DDT_CNT) echo $results->DDT_CNT;?>" numberOnly
                          placeholder='소득액을 입력 해주세요.'>
                      </div>
                    </div>
                    <!-- End 제목 Input -->
                  ...
                  <div class='col-md-12 text-center'>
                    ...
                    <a href="dataD?pageNo=<?php echo $pageNo;?>&search=<?php echo $search;?>"
