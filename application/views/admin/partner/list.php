          ...
          <div class="g-pa-20 CTs-list-notice m---style01" id="CTs-list">
            ...
            <div class="media">
              <div class="d-flex align-self-center">
                <h1 class="g-font-weight-300 g-font-size-25 g-color-black mb-0 page-big-title">파트너사 LIST</h1>
              </div>
              <div class="media-body align-self-center text-right">
                <a class=" btn btn u-btn-primary g-width-100--md g-font-size-default g-ml-10" href="partnerWrite">+ ADD
                </a>
              </div>
            </div>
            ...
            <div class="media-md align-items-center g-mb-30">
              <div class="media d-md-flex align-items-center ml-auto">
                <div class="d-flex g-ml-15 g-ml-55--md">
                  <form action='./partner' method='get' id='frm' name='frm'>
              ...
              <div class="table-responsive">
                <table class="table table-striped">
                  <colgroup class='g-hidden-sm-down'>
                    ...
                    <col style='width:10%;' class='g-hidden-sm-down'>
                    <col style='width:10%;' class='g-hidden-sm-down'>
                    <col style='width:16%;' class='g-hidden-sm-down'>
                  </colgroup>
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class='table_title'>
                        <a href='partnerWrite?PTT_IDX=<?php echo $data->PTT_IDX;?>&search=<?php echo $search;?>&pageNo=<?php echo $pageNo;?>'
                          class="g-color-black"><?php echo decrypt($data->PTT_NAME);?></a>
                      </td>
                      <td>
                        <a href='partnerWrite?PTT_IDX=<?php echo $data->PTT_IDX;?>&search=<?php echo $search;?>&pageNo=<?php echo $pageNo;?>'
                          class="g-color-black"><?php echo decrypt($data->PTT_TEL);?></a>
                      </td>
                      <td>
                        <a href='partnerWrite?PTT_IDX=<?php echo $data->PTT_IDX;?>&search=<?php echo $search;?>&pageNo=<?php echo $pageNo;?>'
                          class="g-color-black"><?php echo decrypt($data->PTT_EMAIL);?></a>
                      </td>
                      <td><?php echo $data->PTT_REG_DATE;?></td>
                      <td class="text-right">
                        <a href="partnerCase?PTT_IDX=<?php echo $data->PTT_IDX;?>"
                          class="btn btn-xs u-btn-blue g-mr-10">
                          <i class="icon-notebook g-mr-3"></i>
                          시공사례 관리
                        </a>
                        <a href="partnerWrite?PTT_IDX=<?php echo $data->PTT_IDX;?>&search=<?php echo $search;?>&pageNo=<?php echo $pageNo;?>"
                          class="btn btn-xs u-btn-indigo g-ml-10 g-mr-10 ">
                          <i class="hs-admin-pencil g-mr-3"></i>
                          MODIFY
                        </a>
                        <a href="/adminDAO/partner_delete?PTT_IDX=<?php echo $data->PTT_IDX;?>&search=<?php echo $search;?>&pageNo=<?php echo $pageNo;?>"
