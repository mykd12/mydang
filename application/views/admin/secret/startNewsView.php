  ...
  <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
    <ul class="u-list-inline g-color-gray-dark-v6 add-location">
      ...
      <li class="list-inline-item">
        <span class="g-valign-middle">소식 DETAIL</span>
      </li>
    </ul>
  </div>
  <!-- End Breadcrumb-v1 -->
  ...
  <div class="g-pa-20" id="CTs-view">
    <div class="media">
      <div class="d-flex align-self-center">
        <h1 class="g-font-weight-300 g-font-size-25 g-color-black mb-0 page-big-title">소식 DETAIL</h1>
      </div>
    </div>
        ...
        <div class="card g-brd-gray-light-v7 g-rounded-3 g-mb-30 add-view-page">
          <header class="card-header g-bg-transparent g-brd-bottom-none g-px-15 g-px-30--sm g-pt-15 g-pt-20--sm pb-0">
            <div class="media">
              <h3
                ...
                [<?php echo $results->SNT_TYPE?>] <?php echo $results->SNT_TITLE?></h3>
                    ...
                    <ul class="list-unstyled g-nowrap mb-0">
                      <li>
                        <a class="d-flex align-items-center u-link-v5 g-bg-gray-light-v8--hover g-font-size-12 g-font-size-default--md g-color-gray-dark-v6 g-px-25 g-py-14"
                          href="startNewsWrite?SNT_IDX=<?php echo $results->SNT_IDX?>&pageNo=<?php echo $pageNo;?>&search=<?php echo $search;?>">
                      ...
                      <li>
                        <a class="d-flex align-items-center u-link-v5 g-bg-gray-light-v8--hover g-font-size-12 g-font-size-default--md g-color-gray-dark-v6 g-px-25 g-py-14"
                          href="/adminDAO/startNewsDelete?SNT_IDX=<?php echo $SNT_IDX?>&search=<?php echo $search;?>&pageNo=<?php echo $pageNo;?>"
          ...
          <div class="card-block">
            <div class="card g-brd-gray-light-v7 g-pt-30 g-pb-30 g-px-30--sm g-bg-gray-light-v5">
              <?php echo $results->SNT_CONTENT;?>
            </div>
          </div>
        </div>
        <!-- End Panel -->
      </div>
      <?php if($results->SNT_IMG_SAVE){?>
          ...
          <div class="card g-brd-gray-light-v7 g-px-20--sm g-pt-30 g-pb-30 g-mb-20 text-center ">
            <a class=" g-mb-30 g-mb-0--md" href="javascript:;" data-fancybox="<?php echo $results->SNT_IMG_ORG;?>"
              ...
              <img class="img-fluid" src="../../uploads/<?php echo $results->SNT_IMG_SAVE?>"
                alt="<?php echo $results->SNT_IMG_ORG?>" STYLE='max-width:250px;'>
            </a>
          </div>
        </div>
      </div>
