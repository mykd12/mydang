        <div class="col g-ml-50 g-ml-0--lg g-overflow-hidden">
          ...
          <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
            <ul class="u-list-inline g-color-gray-dark-v6 add-location">
              ...
              <li class="list-inline-item g-mr-10">
                <a class="u-link-v5 g-color-gray-dark-v6 g-color-lightblue-v3--hover g-valign-middle" href="#!">일반회원
                  LIST</a>
              </li>
          ...
          <div class="g-pa-20 CTs-list-notice m---style01" id="CTs-list">
            ...
            <div class="media">
              <div class="d-flex align-self-center">
                <h1 class="g-font-weight-300 g-font-size-25 g-color-black mb-0 page-big-title">일반회원 LIST</h1>
              </div>
            </div>
              ...
              <div class="media d-md-flex align-items-center mr-auto ">
                <div class="d-flex align-items-center">
                  <a class=" btn btn u-btn-indigo g-width-130--md g-font-size-default g-ml-10"
                    href="userExcel?search=<?php echo $search;?>" target='_blank'>EXCEL DOWN</a>
                </div>
              </div>
              <div class="media d-md-flex align-items-center ml-auto">
                <div class="d-flex g-ml-15 g-ml-55--md">
                  <form action='./user' method='get' id='frm' name='frm'>
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href='/admin/userWrite?MET_IDX=<?php echo $data->MET_IDX?>&search=<?php echo $search;?>&pageNo=<?php echo $pageNo;?>'
                          class="g-color-black"><?php echo decrypt($data->MET_EMAIL);?></a>
                      </td>
                      <td class='table_title'>
                        <a href='/admin/userWrite?MET_IDX=<?php echo $data->MET_IDX?>&search=<?php echo $search;?>&pageNo=<?php echo $pageNo;?>'
                          class="g-color-black"><?php echo decrypt($data->MET_NAME);?></a>
                      </td>
                      <td>
                        <?php echo $data->MET_REG_DATE;?>
                      </td>
                      <td class="text-right">
                        <a href="/admin/userWrite?MET_IDX=<?php echo $data->MET_IDX?>&?search=<?php echo $search;?>&pageNo=<?php echo $pageNo;?>"
                        ...
                        <a href="/adminDAO/user_delete?MET_IDX=<?php echo $data->MET_IDX?>&search=<?php echo $search;?>&pageNo=<?php echo $pageNo;?>"
                          class="btn btn-xs u-btn-primary g-mr-10 " onclick="return confirm('삭제 및 탈퇴 시키시겠습니까??');">
