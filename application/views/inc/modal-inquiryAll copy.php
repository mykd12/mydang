<link rel="stylesheet" href="/css/modalanalysis.css?v=<?php echo time(); ?>">
...
$('input.num_only').on('keyup', function() {
  ...
  var sum1 = parseInt($("#fn_type1_price").val() ||
    0); // input 값을 가져오며 계산하지만 값이 없을경우 0이 대입된다  뒷부분에 ( || 0 ) 없을경우 합계에 오류가 생겨 NaN 값이 떨어진다
