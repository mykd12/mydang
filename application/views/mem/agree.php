  ...
  <div class="container-inner">
    ...
    <div class="content">
      <div class="content-inner">
        ...
        <div class="form-wrap">
          <form id="agree_form" name="agree_form" method="post" action="/main/join01" onsubmit="return submit_ck();">
            <!-- 홈페이지 이용약관 동의 -->
            <div class="agree-wrap">
              ...
              <div class="agree_box">
                ...
                <div class="form_checkbox">
                  ...
                  <label for="agree4">개인정보 제3자 제공에 동의합니다</label>
                </div>
              </div>
            </div>
            <!--전체 동의 -->
            ...
            <div class="submit-wrap">
              <input type="submit" title="다음가입단계" alt="다음가입단계" value="다음 단계" class="btn_next" id="">
            </div>
            <!-- 본인인증 -->
            <!-- <div class="prsnlCrtfc-wrap">
              <h4>- 본인인증 -</h4>
              <p class="text-de">회원가입 진행을 위해 본인 인증이 필요합니다.</p>
              <a href="javascript:callSa();" class="btn-prsnlCrtfc">
                ...
                <p>본인 명의의 휴대폰으로 인증 후 가입하실수 있습니다.</p>
              </a>
            </div> -->
          </form>
        </div>
  ...
  <!--
    function submit_ck(){
      if(!$("#agree1").is(":checked")){
        ...
        alert("위치기반서비스 이용약관에 동의를 해주셔야합니다.");
        $("#agree2").focus();
        return false;
      }else if(!$("#agree4").is(":checked")){
        alert("개인정보 제3자 제공에 동의를 해주셔야 합니다.");
        $("#agree4").focus();
        return false;
      }else{
        return true;
...
$('#agree1').on("click", function() {
  if ($(this).is(':checked') && $('#agree2').is(':checked') && $('#agree3').is(':checked') && $('#agree4').is(':checked')) {
...
$('#agree2').on("click", function() {
  if ($(this).is(':checked') && $('#agree1').is(':checked') && $('#agree3').is(':checked') && $('#agree4').is(':checked')) {
    $("#agreeAll").prop('checked', true);
  } else {
    $("#agreeAll").prop('checked', false);
  }
...
$('#agree3').on("click", function() {
  if ($(this).is(':checked') && $('#agree2').is(':checked') && $('#agree1').is(':checked') && $('#agree4').is(':checked')) {
    $("#agreeAll").prop('checked', true);
  } else {
    $("#agreeAll").prop('checked', false);
  }
...
$('#agree4').on("click", function() {
  if ($(this).is(':checked') && $('#agree3').is(':checked') && $('#agree2').is(':checked') && $('#agree1').is(':checked')) {
    $("#agreeAll").prop('checked', true);
  } else {
    $("#agreeAll").prop('checked', false);
  }
