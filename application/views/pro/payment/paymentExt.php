      ...
      <div class="content-inner">
        <div class="form_wrap">
          ...
          <form id="pymnt_form" method="post">
            ...
            <input type="hidden" name="key" id="key" value="<?php echo $slotkey;?>" />
            ...
            <input type="hidden" name="psCnt" id="psCnt" value="<?php echo $slot->PPT_CNT;?>">
            ...
            <div class="form-group select-wrap">
              ...
              <p class="prc">* 가상계좌 입금확인시 최대 1일 정도 소요되며 입금후 결제업무처리절차에 따라 광고 희망일은 부터 가능합니다. </p>
            </div>
            <div class="form-group adYear">
              ...
              <h4>광고 희망일</h4>
              <div class="int_box">
                <input class="Datepicker left" type="text" name="strtD" id="strtDD"
                  value="<?php echo date("Y-m-d", strtotime($slot->PST_END) );?>" autocomplete="off" readonly>
                <!-- </div> -->
                <!-- <div class="icon-wrap"> -->
                ...
                <input class="text right" type="text" name="lastD" id="lastDD" readonly>
              </div>
            </div>
            <div class="bottomBtn-wrap">
              ...
              <button type="button" class="btn-cncl" onclick="location.href='/pro/advrt';">취소</button>
            </div>
          </form>
        </div>
      </div>
...
$("#psDate").on("change", function() {
  ...
  if (strtD) {
    ...
    today.setDate(today.getDate() + Number(addDate));
  ...
  if (strtD) {
    $("#merchantData").val(key + "," +
      type + "," + psDate + "," + psCnt + "," + strtD + "," + slotkey);
  } else {
    $("#merchantData").val(key + "," +
      type + "," + psDate + "," + psCnt + "," + "," + slotkey);
  }
