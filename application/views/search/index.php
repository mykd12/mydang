  ...
  <div class="map-wrap">
    ...
    <div class="left-wrap">
      ...
      <div class="click-box">
        ...
        <!-- 모바일 상권분석 카테고리 버튼-->
        <div class="btnAly-wrap">
          <!-- <div class="btn-aly"><i class="xi-angle-down-thin"></i> <span class="blind">숨기기,열기</span></div> -->
          <ul class="deth02">
            <li class="on" id="analysTbA"><a href="javascript:void(0)"><span>업소수</span></a></li>
            <li id="analysTbB"><a href="javascript:void(0)"><span>평균매출</span></a></li>
            <li id="analysTbC"><a href="javascript:void(0)"><span>유동인구</span></a></li>
            <li class="sec" id="analysTbD" style="display:none"><a href="javascript:void(0)"><span>pc방 / 노래방</span><i
                  class="xi-close-min"></i></a></li>
          </ul>
        </div>
        <!-- 모바일 수익계산 아이콘-->
        <!-- <a href="javascript:void(0);" class="btn-calculator">
          <div class="img-wrap"></div>
          <p>수익계산</p>
        </a> -->
        <a href="#modal-ernngClclt" class="btn-calculator" rel="modal:open" id="ernngClclt">
          <div class="img-wrap"></div>
          <p>수익계산</p>
        </a>
        <!-- 상권분석 셀렉트 -->
    ...
    <!-- <div class="map-color">
          ...
          <div class="blue-saturation saturation">
            <p>동명동</p>
            <p class="mAlyNum">12345<span class="text">개</span></p>
            <p class="num">0</p>
        </div>
        </div>
  ...
  if (filter.indexOf(navigator.platform.toLowerCase()) < 0) {
    ...
    $(".btn-stores01").on('click', function() {
      ...
      if ($(this).hasClass("on")) {
        ...
        $(".m-bg").addClass("on");
        $('.btnAly-wrap').addClass('on');
        $('.btnAly-wrap .deth02').addClass('on');
        $('.btn-calculator').addClass('on');
        // setTimeout(function() {
    ...
    $('.btn-aly').on('click', function() {
      $('.btn-aly').toggleClass('on');
      $('.btnAly-wrap .deth02').toggleClass('on');
      $('.btn-calculator').toggleClass('on');
    });

    if ($('.select-box01').hasClass("aos-animate")) {
      $('.Mbtn-List').css('display', 'none');
    } else if (!$('.select-box01').hasClass("aos-animate")) {
      $('.Mbtn-List').css('display', 'block');
    }
    // 상권분석창삭제
      ...
      if ($("#selectS").val() == "서울특별시") {
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            if ($("#storeB").val() == '21') {
              randomA = data[0][0].DIT_DATA_A1;
              storeCnt = data[0][0].DIT_DATA_A2;
            } else if ($("#storeB").val() == '22') {
              randomA = data[0][0].DIT_DATA_B1;
              storeCnt = data[0][0].DIT_DATA_B2;
            } else if ($("#storeB").val() == '23') {
              randomA = data[0][0].DIT_DATA_C1;
              storeCnt = data[0][0].DIT_DATA_C2;
            } else if ($("#storeB").val() == '24') {
              randomA = data[0][0].DIT_DATA_D1;
              storeCnt = data[0][0].DIT_DATA_D2;
            } else if ($("#storeB").val() == '25') {
              randomA = data[0][0].DIT_DATA_E1;
              storeCnt = data[0][0].DIT_DATA_E2;
            } else if ($("#storeB").val() == '26') {
              randomA = data[0][0].DIT_DATA_F1;
              storeCnt = data[0][0].DIT_DATA_F2;
            } else if ($("#storeB").val() == '27') {
              randomA = data[0][0].DIT_DATA_G1;
              storeCnt = data[0][0].DIT_DATA_G2;
            } else if ($("#storeB").val() == '28') {
              randomA = data[0][0].DIT_DATA_H1;
              storeCnt = data[0][0].DIT_DATA_H2;
            } else if ($("#storeB").val() == '29') {
              randomA = data[0][0].DIT_DATA_I1;
              storeCnt = data[0][0].DIT_DATA_I2;
            } else if ($("#storeB").val() == '30') {
              randomA = "-";
              storeCnt = "-";
            } else if ($("#storeB").val() == '31') {
              randomA = data[0][0].DIT_DATA_J1;
              storeCnt = data[0][0].DIT_DATA_J2;
            } else if ($("#storeB").val() == '32') {
              randomA = data[0][0].DIT_DATA_K1;
              storeCnt = data[0][0].DIT_DATA_K2;
            } else if ($("#storeB").val() == '33') {
              randomA = data[0][0].DIT_DATA_L1;
              storeCnt = data[0][0].DIT_DATA_L2;
            } else if ($("#storeB").val() == '41') {
              randomA = data[0][0].DIT_DATA_M1;
              storeCnt = data[0][0].DIT_DATA_M2;
            } else if ($("#storeB").val() == '42') {
              randomA = data[0][0].DIT_DATA_N1;
              storeCnt = data[0][0].DIT_DATA_N2;
            } else if ($("#storeB").val() == '43') {
              randomA = data[0][0].DIT_DATA_O1;
              storeCnt = data[0][0].DIT_DATA_O2;
            } else if ($("#storeB").val() == '44') {
              randomA = data[0][0].DIT_DATA_P1;
              storeCnt = data[0][0].DIT_DATA_P2;
            }
            console.log(randomA);
            console.log(storeCnt);
            $("#population").text(comma(uncomma(data[0][0].DIT_DATA_Q)));
            var money = 1555 * 1.5;
            ...
            $("#analySales").text(comma(uncomma(randomA)));
