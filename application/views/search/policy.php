      ...
      <div class="contents">
        <div id="policy01" class="sg-main">
          ...
          <section class="sg-agent">
            ...
            <ol>
              ...
              <li>
                <span class="listNum">2.</span>
                <span class="sg-text">
                  "회사"가 제공하는 서비스는 원칙적으로 상품 중도 변경, 일시중지, 양도양수가 불가합니다. 단, 이용자의 귀책사유가 아님을 증명 할 수 있을 경우 예외적으로 처리될 수 있습니다.
                </span>
              </li>
              <li>
                <span class="listNum">3.</span>
          ...
          <section class="sg-agent">
            ...
            <ol>
              ...
              <li>
                <span class="listNum">4.</span>
                <span class="sg-text">
                  "회원"이 계약을 해지하는 경우, 관련법 및 "개인정보취급방침"에 따라 "회사"가 회원정보를 보유하는 경우를 제외하고는 해지 즉시 "회원"의 모든 데이터는 소멸됩니다.
                </span>
              </li>
            </ol>
          </section>
          <section class="sg-agent">
            ...
            <ol>
              ...
              <li>
                <span class="listNum">7.</span>
                <span class="sg-text">
                  "회사" 또는 그로부터 개인정보를 제공받은 제3자는 개인정보의 수집목적 또는 제공받은 목적을 달성한 때에는 당해 개인정보를 지체 없이 파기합니다. 다만, 아래의 경우에는 회원 정보를
                  보관합니다. 이 경우 회사는 보 관하고 있는 회원 정보를 그 보관의 목적으로만 이용합니다.
                  <ol>
                    <li>
                      <span class="listNum">1)</span>
                      <span class="sg-text">
                        상법, 전자상거래 등에서의 소비자보호에 관한 법률 등 관계법령의 규정에 의하여 보존할 필요가 있는 경우 "회사"는 관계법령에서 정한 일정한 기간 동안 회원 정보를
                        보관합니다.
                      </span>
                    </li>
                    <li>
                      <span class="listNum">2)</span>
                      <span class="sg-text">
                        "회사"가 이용계약을 해지하거나 "회사"로부터 서비스 이용정지조치를 받은 회원에 대해서는 재가입에 대한 승낙거부사유가 존재하는지 여부를 확인하기 위한 목적으로 이용계약종료
          ...
          <section class="sg-agent">
            ...
            <ol>
              <li>
                <span class="listNum">1.</span>
                <span class="sg-text">
                  "회원"이 계약 상품 개시 후 환불 요청시 개시일로부터 경과기간에 해당하는 상품 원가 금액과 총 결제금액의 10% 위약금을 공제 한 후 그 나머지를 환급합니다. "공인중개사 회원"이
                  중개업을 폐업 신고한 후 환불 요청하는 경우도 같습니다. 단, 상품 계약일로부터 7일 이내 청약철회 요청 시 위약금 없이 상품 개시일로부터 경과기간에 해당하는 상품 원가 금액만
                  공제하고 그 나머지를 환급합니다.
                </span>
              </li>
              <li>
                <span class="listNum">2.</span>
                <span class="sg-text">
                  신용카드로 결제한 "회원"이 카드 승인일로부터 365일이내에 환불을 요청할 경우 환불금액이 부분취소처리 됩니다. 단, 그 외의 경우에는 기존에 결제하였던 내역을 전액 취소하며 취소
                  시점에 따라 1항에 의거한 환불공제 금액을 재승인 합니다. 이 경우 구매 취소 시점과 해당 카드사의 환불 처리기준에 따라 취소금액의 환급 방법과 환급일은 다소 차이가 있을 수 있으며,
              ...
              <li>
                <span class="listNum">3.</span>
                <span class="sg-text">
                  "회원"이 타인의 신용카드 또는 휴대전화번호를 도용하여 부당한 이익을 편취하였다고 볼 수 있는 합리적 사유가 있는 경우 "회사"는 "회원"에게 소명 자료를 요청하고 환불을 보류할 수
                  있습니다.
                </span>
              </li>
              <li>
          ...
          <section class="sg-agent">
            ...
            <ol>
              ...
              <li>
                ...
                <span class="sg-text">
                  ...
                  <ol>
                    <li>
                      <span class="listNum">1)</span>
                      <span class="sg-text">이용 목적 : 회사 서비스 운영 전반, 회사 서비스의 온/오프라인 광고, 회사 서비스 고도화 및 기획, 운영 등을 위한 빅데이터
                        수집</span>
                    </li>
                    <li>
                      <span class="listNum">2)</span>
                      <span class="sg-text">이용 권한 : 회사 서비스 및 회사와 제휴된 서비스에 노출할 수 있고, 해당 노출을 위해 필요한 범위 내에서 일부 이용, 편집 형식의
                        변경 및 기타 변형하여 이용할 수 있습니다. (사용, 저장, 수정, 복제, 공중송신, 전시, 공표, 공연, 전송, 배포, 방송, 2차적 저작물 작성 등 어떠한 형태로든 이용
              ...
              <li>
                <span class="listNum">3.</span>
                <span class="sg-text">"회원"은 본조 2항의 콘텐츠 이용 허락에 대한 권리를 보유해야 합니다. 이에 반하여 발생하는 모든 문제에 대해서는 “회원”이 책임을 부담하게
                  됩니다.</span>
              </li>
              <li>
                <span class="listNum">4.</span>
                <span class="sg-text">"회원"이 작성한 콘텐츠는 제3자의 권리를 침해해서는 아니됩니다. 관련 법령에 위반되는 내용을 포함하는 경우 그로 인한 책임은 “회원”이 부담하게
                  되며, 관련 법령이 정한 절차에 따라 게시가 제한될 수 있습니다.</span>
              </li>
              <li>
                <span class="listNum">5.</span>
                <span class="sg-text">서비스에 대한 저작권 및 지적재산권은 “회사”에 귀속됩니다. 단, 회원이 직접 작성한 "콘텐츠" 및 제휴 계약에 따라 제공된 저작물 등은
                  제외합니다.</span>
              </li>
              <li>
                <span class="listNum">6.</span>
                <span class="sg-text">"이용자"는 서비스를 이용함으로써 얻은 정보 중 "회사"에게 지적 재산권이 귀속된 정보를 회사의 사전 승낙 없이 복제, 송신, 출판, 배포, 방송
        ...
        <div id="policy02" class="sg-main">
          ...
          <section class="sg-agent" id="begin">
            <h2>1. 총칙</h2>
            <p>
              (주)디노랩스(이하 "회사"라 한다)은 회원의 개인정보보호를 소중하게 생각하고, 회원의 개인정보를 보호하기 위하여
              항상 최선을 다해 노력하고 있습니다.
            </p>
            <ol>
              <li>
                <span class="listNum">1)</span>
                <span class="sg-text">
                  "회사"는 "정보통신망 이용촉진 및 정보보호 등에 관한 법률"을 비롯한 모든 개인정보보호 관련 법률규정을 준
                  수하고 있으며, 관련 법령에 의거한 개인정보취급방침을 정하여 이용자 권익 보호에 최선을 다하고 있습니다.
                </span>
              </li>
              <li>
                <span class="listNum">2)</span>
                <span class="sg-text">
                  "회사"는 "개인정보취급방침"을 제정하여 이를 준수하고 있으며, 이를 인터넷사이트 및 모바일 애플리케이션
                  에 공개하여 이용자가 언제나 용이하게 열람할 수 있도록 하고 있습니다.
                </span>
              </li>
            </ol>
          </section>
          <section class="sg-agent">
            <h2>2. 개인정보의 수집방법 및 항목</h2>
            <p>"회사"는 회원가입과 상담, 각종 서비스의 제공 등을 위해 아래와 같은 개인정보를 수집하고 있습니다.</p>
            <ol>
              <li>
                <span class="listNum">1)</span>
                <span class="sg-text">
                  회원가입 시점에서 수집하는 항목<br>
                  - E-mail 주소, 휴대폰 번호, 비밀번호(단, 공인중개사 회원의 경우 중개업소명, 중개업소 대표연락처, 중개업소
                  등록번호, 중개업소 대표자 정보 등 중개업소와 관련된 사항을 추가로 수집하며, 비즈니스 회원의 경우 회사명과
                  대표연락처 사업자 등록번호 대표자 정보 등 비즈니스 회원과 관련된 사항을 추가 수집합니다. )
                </span>
              </li>
              <li>
                <span class="listNum">2)</span>
                <span class="sg-text">
                  ...
                  <ul>
                    <li>
                      ...
                      <span class="sg-text">서비스 이용과정에서 이용자가 입력한 정보 및 작성한 저작물</span>
                    </li>
                    <li>
                      <span class="listNum">-</span>
                      <span class="sg-text">모든 기능을 이용하는 과정에서 휴대폰 번호 또는 전화번호</span>
                    </li>
                    <li>
                      <span class="listNum">-</span>
                      <span class="sg-text">사업자등록번호, 점포 사진, 월세, 보증금, 권리금 등 이용자의 점포에 관한 정보</span>
                    </li>
                    <li>
                      <span class="listNum">-</span>
                      <span class="sg-text">고객센터 통화내용 녹취본</span>
                    </li>
                    <li>
                      <span class="listNum">-</span>
                      <span class="sg-text">ADID/IDFA</span>
                    </li>
                  </ul>
                </span>
              </li>
              <li>
                ...
                <span class="sg-text">
                  ...
                  <ul>
                    <li>
                      <spna class="listNum">-</spna>
                      <span class="sg-text">
                        웹페이지, 모바일 애플리케이션, 서면양식, 팩스, 고객센터를 통한 전화와 온라인 상담, 이벤트 응모 등
                      </span>
                    </li>
                    <li>
                      <spna class="listNum">-</spna>
                      <span class="sg-text">생성정보 수집 Tool을 통한 수집</span>
                    </li>
                  </ul>
                </span>
              </li>
          ...
          <section class="sg-agent">
            ...
            <ol>
              ...
              <li>
                ...
                <span class="sg-text">
                  회원관리<br>
                  회원제 서비스 이용, 개인식별, 불량회원의 부정 이용방지와 비인가 사용방지, 가입의사 확인, 가입 및 가입횟수 제
                  한, 분쟁 조정을 위한 기록보존, 불만처리 등 민원처리, 고지사항 전달
                </span>
              </li>
              <li>
                <span class="listNum">3)</span>
                <span class="sg-text">
                  마케팅 및 광고에의 활용<br>
                  고객별 맞춤 서비스 제공, 통계학적 특성에 따른 서비스 제공 및 광고 게재, 정기 간행물 발송, 서비스의 유효성 확
                  인, 이벤트 및 광고성 정보 제공 및 참여기회 제공, 접속빈도 파악, 회원의 서비스 이용에 대한 통계
                </span>
              </li>
            </ol>
          </section>
          <section class="sg-agent">
            <h2>4. 개인정보 수집, 이용, 제공에 대한 동의</h2>
            <p>
              "회사"는 "이용자"가 최초 회원가입 시 또는 서비스 이용과 관련해 개인정보를 입력할 시 개인정보취급방침 및 이
              용약관 등의 내용에 대해 동의 여부를 체크할 수 있는 절차를 마련하여, 이를 체크하면 개인정보수집에 대해 동의
              한 것으로 취급합니다
            </p>
          </section>
          <section class="sg-agent">
            ...
            <ol>
              <li>
                <span class="listNum">1)</span>
                <span class="sg-text">
                  "회사"는 "이용자"의 개인정보를 "3. 개인정보의 수집 및 이용목적" 에서 고지한 범위 내에서 사용하며 동의 범
                  위를 초과하여 이용하거나 원칙적으로 제 3자에게 제공하지 않습니다
                </span>
              </li>
              <li>
                <span class="listNum">2)</span>
                <span class="sg-text">
                  다만 제휴관계나 위탁처리를 위한 경우 합당한 절차를 통한 회원의 동의를 얻어 개인정보를 제공 또는 이용할
                  수 있습니다.
                  <ul>
                    <li>
                      <span class="listNum">-</span>
                      <span class="sg-text">
                        제휴관계: 보다 나은 서비스 제공을 위하여 회사는 회원의 개인정보를 제휴사에 제공할 수 있습니다. 이 경우
                        사전에 회원에게 제휴사, 제공되는 개인정보의 항목, 개인정보 제공 목적, 제공기간, 개인정보보호방안 등에 대해
                        개별적으로 동의를 구하는 절차를 거치게 되며, 회원의 동의가 없는 경우에는 제휴사에게 이를 제공하지 않으며,
                        제휴관계의 변화 또는 종결될 경우에도 고지합니다. 또한 제휴관계가 종결될 경우 제공된 개인정보에 대해서는 회
                        원님의 동의가 없는 경우 지체 없이 파기하도록 조치하며 개인정보 제공에 동의하더라도 언제든지 그 동의를 철회
                        할 수 있습니다.
                      </span>
                    </li>
                    <li>
                      <span class="listNum">-</span>
                      <span class="sg-text">
                        위탁처리: 원활한 업무처리와 회원에게 보다 나은 서비스 제공을 위하여 회원의 개인정보를 위탁하여 처리할
                        수 있으며, 이 경우 반드시 사전에 위탁처리 업체명과 목적, 위탁처리 되는 개인정보의 범위, 위탁기간 등에 대해
                        상세하게 고지합니다
                      </span>
                    </li>
                  </ul>
              ...
              <li>
                ...
                <span class="sg-text">
                  ...
                  <ul>
                    <li>
                      <span class="listNum">-</span>
                      <span class="sg-text">서비스 제공에 따른 요금정산을 위하여 필요한 경우</span>
                    </li>
                    <li>
                      <span class="listNum">-</span>
                      <span class="sg-text">
                        "회사"가 제공하는 서비스를 통하여 거래가 성사된 경우, 거래 당사자간의 원활한 의사소통을 위하여 관련된
                        정보를 필요한 범위 내에서 거래당사자에게 제공하는 경우
                      </span>
                    </li>
                    <li>
                      <span class="listNum">-</span>
                      <span class="sg-text">"이용자"들이 사전에 동의한 경우</span>
                    </li>
                    <li>
                      <span class="listNum">-</span>
                      <span class="sg-text">
                ...
                <span class="sg-text">
                  ...
                  <table>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>(주)직방</td>
                        <td>부동산 매물 및 중개사 정보 공개</td>
                        <td>중개사 정보(성명, 연락처,이메일), 매물 정보</td>
                      </tr>
                    </tbody>
                  </table>
                </span>
          ...
          <section class="sg-agent">
            ...
            <ol>
              <li>
                <span class="listNum">1)</span>
                <span class="sg-text">
                  "회사"가 "회원"의 개인정보를 수집하는 경우 그 보유기간은 원칙적으로 회원가입 후 약관 제10조에 의한 ‘계약
                  기간 및 이용계약의 종료시’까지며, 이용계약 종료의 경우 회사는 회원의 개인정보를 즉시 파기하며 제3자에게 기
                  제공된 정보에 대해서도 지체 없이 파기하도록 조치합니다. (단, 재가입유예기간 동안의 재가입 방지 등을 위해 이
                  용계약이 종료한 날로부터 2개월 경과 후에 파기하도록 합니다.)
                  또한, 다음의 경우 각각 명시한 기간 동안 개인정보를 보유합니다.
                  <ol>
                    <li>
                      <span class="listNum">(1)</span>
                      <span class="sg-text">
                        상법 등 법령의 규정에 의하여 보존할 필요성이 있는 경우 법령에서 규정한 보존기간 동안 거래내역과 최소한
                        의 기본정보를 보유
                      </span>
                    </li>
                    <li>
                      <span class="listNum">(2)</span>
                      <span class="sg-text">
                        보유기간을 미리 공지하고 그 보유기간이 경과하지 아니한 경우와 개별적으로 회원의 동의를 받을 경우에는
                        약정한 기간 동안 보유
                      </span>
                    </li>
                    <li>
              ...
              <li>
                <span class="listNum">2)</span>
                <span class="sg-text">
                  "회사"는 고객의 개인정보를 보호하여 개인정보 유출로 인한 피해가 발생하지 않도록 하기 위하여 다음과 같은
                  방법을 통하여 개인정보를 파기합니다.
                  <ul>
                    <li>
                      <span class="listNum">-</span>
                      <span class="sg-text">종이에 출력된 개인정보는 분쇄기로 분쇄하거나 소각을 통하여 파기합니다.</span>
                    </li>
                    <li>
                      <span class="listNum">-</span>
                      <span class="sg-text">전자적 파일 형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제합니다.</span>
                    </li>
                  </ul>
                </span>
              </li>
              <li>
                <span class="listNum">3)</span>
                <span class="sg-text">
                  "회원"의 동의를 받아 보유하고 있는 개인정보에 대한 당해 회원의 열람요구가 있을 경우 회사는 지체 없이 이
                  를 열람, 확인할 수 있도록 조치합니다.
                </span>
              </li>
              <li>
                <span class="listNum">4)</span>
                <span class="sg-text">
                  개인정보보호법에 의한 개인정보 보유<br>
                  "회원"이 1년간 서비스 이용기록이 없는 경우 "개인정보보호법 제39조의6(개인정보의 파기에 대한 특례)"에 따라회원
                  에게 사전 통지하고 별도로 분리하여 저장합니다.
                </span>
              </li>
              <li>
                <span class="listNum">5)</span>
                <span class="sg-text">
                  개인정보의 국외 보관에 대한 내용<br>
                  "회사"는 이용자로부터 취득 또는 생성한 개인정보를 "MS AZURE"가 보유하고 있는 데이터베이스(물리적보관소:
                  한국,일본)에 저장합니다. "MS AZURE"는 해당 서버의 물리적인 관리만을 행하고, 원칙적으로 회원님의 개인정보에 접근하지 않습니다.
                </span>
              </li>
            </ol>
          ...
          <section class="sg-agent">
            ...
            <ol>
              <li>
                <span class="listNum">1)</span>
                <span class="sg-text">
                  "이용자" 및 “법정대리인”은 언제든지 등록되어 있는 자신
                  또는 대리자의 개인정보를 조회하거나 수정할 수 있으며 가
                  입 해지를 요청할 수도 있습니다.
                </span>
              </li>
              <li>
                <span class="listNum">2)</span>
                <span class="sg-text">
                  "이용자" 혹은 “법정대리인”의 개인정보 조회, 수정을 위
                  해서는 ‘내 정보’를, 가입 해지(동의철회)를 위해서는 고객센
                  터를 통해 본인확인 절차를 거치신 후 직접 열람, 정정 또는
                  탈퇴 요청이 가능합니다.
                </span>
              </li>
              <li>
                <span class="listNum">3)</span>
                <span class="sg-text">
                  “이용자” 혹은 “법정대리인”이 개인정보관리책임자에게 서
                  면, 전화 또는 이메일로 연락하여 개인정보의 조회, 수정 및
                  가입 해지 요청이 가능 합니다.
                </span>
              </li>
              <li>
                <span class="listNum">4)</span>
                <span class="sg-text">
                  “이용자” 혹은 “법정대리인”이 개인정보의 오류에 대한 정
                  정을 요청하신 경우에는 정정을 완료하기 전까지 당해 개인
                  정보를 이용 또는 제공 하지 않습니다. 또한 잘못된 개인정보
                  를 제 3자에게 이미 제공한 경우에는 정정 처리결과를 제3자
                  에게 통지합니다.
                </span>
              </li>
              <li>
                <span class="listNum">5)</span>
                <span class="sg-text">
                  "회사"는 “이용자” 혹은 “법정대리인”의 요청에 의해 해지
                  또는 삭제된 개인정보를 "6. 개인정보의 보유기간 및 파기"에
          ...
          <section class="sg-agent">
            <h2>8. 개인정보 자동 수집 장치의 설치와 운영 및 거부에 관한 사항</h2>
            <ol>
              <li>
                <span class="listNum">1)</span>
                <span class="sg-text">
                  ...
                  <ul>
                    ...
                    <li>
                      <span class="listNum">-</span>
                      <span class="sg-text">
                        쿠키는 웹 서비스 제공자의 서버가 이용자의 브라우저에게 보내는 소량의 정보이며, 이용자 컴퓨터의 하드디
                        스크에 저장됩니다. 여기에는 방문한 웹사이트의 정보 등이 담겨있습니다. 이후 이용자가 웹 사이트에 방문할 경우
                        웹 사이트 서버는 이용자의 하드 디스크에 저장되어 있는 쿠키의 내용을 읽어 이용자의 환경설정을 유지하고 맞춤
                        화된 서비스를 제공하기 위해 이용됩니다.
                      </span>
                    </li>
                    <li>
                      <span class="listNum">-</span>
                      <span class="sg-text">
                        쿠키는 이용자 컴퓨터의 웹브라우저는 식별하지만 이용자 개인을 식별하는 정보를 자동적/능동적으로 수집하
                        지 않으며, 이용자는 웹브라우저의 옵션 메뉴를 통해 쿠키의 수용 여부 등을 설정할 수 있습니다.
                      </span>
                    </li>
                  </ul>
                </span>
                ...
                <span class="sg-text">
                  ...
                  <ul>
                    <li>
                      <span class="listNum">-</span>
                      <span class="sg-text">
                        "이용자"들이 방문한 "명당"의 각 서비스의 접속여부, 매물확인여부, 문의하기 등에 사용합니다.
                      </span>
                    </li>
                    <li>
                      <span class="listNum">-</span>
                      <span class="sg-text">
                        "이용자"는 쿠키 설치에 대한 선택권을 가지고 있습니다. 따라서 "이용자"는 웹브라우저에서 옵션을 설정함으
                        로써 모든 쿠키를 허용하거나, 쿠키가 저장될 때마다 동의 절차를 거치거나, 아니면 모든 쿠키의 저장을 거부할 수
                        있습니다.
                      </span>
                    </li>
                    <li>
                      <span class="listNum">-</span>
                      <span class="sg-text">
                        다만, 쿠키의 저장을 거부할 경우에는 로그인이 필요한 ‘명당’의 일부 서비스는 이용에 어려움이 있을 수 있습
                        니다.
                      </span>
                    </li>
                  </ul>
          ...
          <section class="sg-agent">
            ...
            <p>
              "회사"는 "이용자"들의 개인정보를 취급함에 있어 개인정보가 분실, 도난, 누출, 변조 또는 훼손되지 않도록 안전성
              확보를 위하여 다음과 같은 기술적/관리적 대책을 강구하고 있습니다. 단, 이용자 본인의 부주의나 인터넷 또는 통
              신상의 문제로 ID, 비밀번호 등 개인정보가 유출되어 발생한 문제에 대해 "회사"는 일체의 책임을 지지 않습니다.
            </p>
            <ol>
              <li>
                <span class="listNum">1)</span>
                <span class="sg-text">
                  비밀번호 암호화<br>
                  회원 아이디(ID)의 비밀번호는 암호화되어 저장 및 관리되고 있어 본인만이 알고 있으며, 개인정보의 확인 및 변경
                  도 비밀번호를 알고 있는 본인에 의해서만 가능합니다.
                </span>
              </li>
              <li>
                <span class="listNum">2)</span>
                <span class="sg-text">
                  ...
                  <ul>
                    <li>
                      <span class="listNum">-</span>
                      <span class="sg-text">
                        "회사"는 해킹이나 컴퓨터 바이러스 등에 의해 회원의 개인정보가 유출되거나 훼손되는 것을 막기 위해 최선을
                        다하고 있습니다. 개인정보의 훼손에 대비해 자료를 수시로 백업하고 있고, 최신 백신프로그램을 이용하여 이용자
                        들의 개인정보나 자료가 누출되거나 손상되지 않도록 방지하고 있으며, 암호화통신 등을 통하여 네트워크상에서
                        개인정보를 안전하게 전송할 수 있도록 하고 있습니다. 그리고 침입차단시스템을 이용하여 외부로부터의 무단 접
                        근을 통제하고 있으며, 기타 시스템적으로 보안성을 확보하기 위한 가능한 모든 기술적 장치를 갖추기 위해 노력하
                        고 있습니다.
                      </span>
                    </li>
                    <li>
                      ...
                      <span class="sg-text">
                        취급 직원의 최소화 및 교육<br>
                        "회사"의 개인정보관련 취급 직원은 담당자에 한정시키고 있고 이를 위한 별도의 비밀번호를 부여하여 정기적으로
                        갱신하고 있으며, 담당자에 대한 수시 교육을 통하여 "명당"의 개인정보취급방침의 준수를 항상 강조하고 있습니
                        다.
                      </span>
                    </li>
                  </ul>
          ...
          <section class="sg-agent">
            <h2>10. 위치기반정보의 수집에 관한 사항</h2>
            <p>서비스 이용과정에서 위치정보가 수집될 수 있으며, 위치기반 서비스에 대한 구체적인 내용은 디노랩스 위치기반서비스 이용약관을 따릅니다.</p>
          </section>
          <section class="sg-agent">
            <h2>11. 개인정보 보호책임자 및 관리자 지정</h2>
            <ol>
              <li>
                <span class="listNum">1)</span>
                <span class="sg-text">
                  개인정보 보호책임자는 고객의 개인정보를 보호하고 유출을 방지하는 책임자로서 이용자가 안심하고 회사가
                  제공하는 서비스를 이용할 수 있도록 도와드리며, 개인정보를 보호하는 데 있어 이용자에게 고지한 사항들에
                  반하여 사고가 발생할 시에는 이에 관한 책임을 집니다.
                </span>
              </li>
              <li>
                <span class="listNum">2)</span>
                <span class="sg-text">
                  기술적인 보완조치를 취하였음에도 불구하고 해킹 등 기본적인 네트워크상의 위험성에 의해 발생하는 예기치
                  못한 사고로 인한 정보의 훼손 및 멸실, "이용자"가 작성한 게시물에 의한 각종 분쟁 등에 관해서는 책임이 없
                  습니다.
                </span>
              </li>
              <li>
                <span class="listNum">3)</span>
                <span class="sg-text">
                  "회사"는 개인정보보호법에서 규정한 관리책임자를 다음과 같이 지정합니다.
                </span>
              </li>
            </ol>
            <br>
            <div class="nemo__information">
            ...
            <div class="nemo__information">
              ...
              <dl>
                ...
                <dd>070-8633-8942</dd>
                <dt>운영시간 :</dt>
                <dd>평일 10:00 ~ 18:00 (점심시간 12:30 ~ 13:30)</dd>
                <dt>FAX :</dt>
                <dd>062.712.2482</dd>
                <dt>E-mail :</dt>
                <dd>denolabs@naver.com</dd>
            ...
            <ul>
              <li>
                <span class="listNum">-</span>
                <span class="sg-text--left10">개인정보침해신고센터 (privacy.kisa.or.kr / 국번없이 118)</span>
              </li>
              <li>
                <span class="listNum">-</span>
                <span class="sg-text--left10">대검찰청 사이버수사과 (www.spo.go.kr / 국번없이 1301)</span>
              </li>
              <li>
                <span class="listNum">-</span>
                <span class="sg-text--left10">경찰청 사이버안전국 (www.ctrc.go.kr / 국번없이 182)</span>
              </li>
            </ul>
          </section>
          <section class="sg-agent">
            <h2>13. 고지의 의무</h2>
            <p>
              개인정보취급방침은 2017년 4월 1일에 제정되었으며, 정부 및 회사의 정책 또는 보안기술의 변경에 따라 내용의 추가, 삭제 및 수정이 있을 경우에는 개정 최소 7일 전부터 서비스의
              '공지사항'란을 통해 고지하며, 본 정책은 시행일자에 시행됩니다.
            </p>
            <ul>
              <li>
                <span class="listNum">가.</span>
                <span class="sg-text">공고일자 : 2021년 12월 31일</span>
              </li>
              <li>
                <span class="listNum">나.</span>
                <span class="sg-text">시행일자 : 2021년 12월 31일</span>
              </li>
            </ul>
          </section>
        </div>
              ...
              <li>
                ...
                <span class="sg-text">
                  ...
                  <dl>
                    ...
                    <dd>070-8633-8942</dd>
                    <dt>이메일:</dt>
                    <dd>cykim@sugarhill.co.kr</dd>
                  </dl>
                </span>
              </li>
            </ol>
            <p>본 약관은 2017년 4월 1일부터 적용 합니다.</p>
          </section>
        </div>
        <div id="policy04" class="sg-main">
          ...
          <section class="sg-agent" id="begin">
            ...
            <p>
              서비스 제공 및 상담, 부정이용 확인 및 방지, 만족도 조사 (고객안심콜 등), 본인·연령확인, 신규서비스 개발, 문의사항 또는 불만·분쟁처리, 맞춤형 서비스 제공, 서비스 개선에 활용,
              계정도용 및 부정거래 방지.
            </p>
            <br>
            <h2>수집하는 개인정보의 항목</h2>
            ...
            <br>
            <p>
              본 서비스 이용을 위해서 필수적인 동의이므로, 동의를 하지 않으면 해당 서비스를 이용하실 수 없습니다. 동의를 거부하는 경우에도 다른 (주)디노랩스의 서비스의 이용에는 영향이 없습니다.
            </p>
          </section>
        </div>
        <div id="policy05" class="sg-main">
          ...
          <section class="sg-agent" id="begin">
            ...
            <br>
            <p>
              본 서비스 이용을 위해서 필수적인 동의이므로, 동의를 하지 않으면 해당 서비스를 이용하실 수 없습니다. 동의를 거부하는 경우에도 다른 (주)디노랩스 서비스의 이용에는 영향이 없습니다.
            </p>
          </section>
        </div>
        <div id="policy06" class="sg-main">
          <section class="sg-main__title">
            <h1>이벤트 및 혜택 알림 수신 동의 (선택)</h1>
          </section>
          <section class="sg-agent" id="begin">
            <h2>개인정보의 수집 및 이용에 대한 안내</h2>
            <p>
                "(주)디노랩스"은 "명당"서비스 제공을 위해서 아래와 같이 개인정보를 수집합니
                다. 정보주체는 본 개인정보의 수집 및 이용에 관한 동의를 거부하실 권리가 있
                으나, 서비스 제공에 필요한 최소한의 개인 정보이므로 동의를 해주셔야 서비스
                를 이용하실 수 있습니다.
            </p>
            <ul>
                <li>
                    <span class="listNum">-</span>
                    <span class="sg-text">
                        수집하려는 개인 정보의 항목: 이름, 휴대폰 번호, 이메일 주소, 비밀번호
                    </span>
                </li>
                <li>
                    <span class="listNum">-</span>
                    <span class="sg-text">
                        개인정보의 수집 및 이용 목적: 회원 관리, 개인식별, 가입의사의 확인, 가입 및
                        가입횟수 제한, 불만사항 접수, 고지사항 전달
                    </span>
                </li>
                <li>
                    <span class="listNum">-</span>
                    <span class="sg-text">개인정보의 보유기간: 회원 탈퇴 후 바로삭제</span>
                </li>
            </ul>
        </section>
